...
const PROJECT_URL = process.env.PROJECT_URL || 'https://www.google.com';    // 需要上传订阅或保活时需填写项目分配的url,例如：https://google.com
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'leaflow.pengproxyz.icu';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"2d02697c5ec66310117425e33a1e9b26","TunnelSecret":"mvwKa978mxgqsLqw0NCwdQQhpxFgkMp8TKH41Q5S7vw=","TunnelID":"d5e449c1-f3d2-434b-a6b9-1dceb8098217","Endpoint":""};
